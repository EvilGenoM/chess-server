package mobi.mpk.chessServerSpring.domain.rules.endgame;
...
import mobi.mpk.chessServerSpring.domain.rules.rule.end.game.ClassicEndGameRule;
import mobi.mpk.chessServerSpring.domain.rules.rule.end.game.EndGameRule;
